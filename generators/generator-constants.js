...
const DOCKER_JHIPSTER_CONSOLE = 'jhipster/jhipster-console:v3.0.0';
const DOCKER_JHIPSTER_CURATOR = 'jhipster/jhipster-curator:v3.0.0';
const DOCKER_JHIPSTER_ELASTICSEARCH = 'jhipster/jhipster-elasticsearch:v3.0.0';
const DOCKER_JHIPSTER_LOGSTASH = 'jhipster/jhipster-logstash:v3.0.0';
const DOCKER_JHIPSTER_IMPORT_DASHBOARDS = 'jhipster/jhipster-import-dashboards:v3.0.0';
const DOCKER_JHIPSTER_ZIPKIN = 'jhipster/jhipster-zipkin:v3.0.0';
